...
PATCHED_SHA = "4672be5706823b86e6187f9f3ddfbb929ce81af240f900b748de90848f087112"
PATCH_SHA = "2e8b610ff4b488122c37d79d4bea9f61d401340925974da4763da5d6cc4ade55"
...
with tempfile.NamedTemporaryFile(suffix=".db") as tmp:
    ...
    try:
        ...
        assert conn.execute("SELECT COUNT(*) FROM question WHERE source_type='real_exam'").fetchone()[0] == 2
        assert conn.execute("SELECT COUNT(*) FROM question WHERE source_type='official_exam_stem_training'").fetchone()[0] == 86
    finally: conn.close()
